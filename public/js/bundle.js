...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1),
	    App = React.createFactory(__webpack_require__(157));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Test = __webpack_require__(158);
	var Another = __webpack_require__(159);
	...
	var App = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(Another, null)
	    );
	  }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var APPEARANCES = [{ title: 'White', range: 'Italian Stone', material: 'Porcelain', finishes: ['Matt', 'Polished', 'Bush Hammered'], image: 'assets/img/appearances/M2-0-60W.jpg' }, { title: 'Ivory', range: 'Mud', material: 'Porcelain', finishes: ['Matt', 'Polished', 'Bush Hammered'], image: 'assets/img/appearances/M2-0-60A.jpg' }, { title: 'Beige', range: 'Italian Stone', material: 'Stone', finishes: ['Matt', 'Polished', 'Bush Hammered'], image: 'assets/img/appearances/M2-0-60B.jpg' }, { title: 'Dark Grey', range: 'Driftwood', material: 'Porcelain', finishes: ['Matt', 'Polished', 'Bush Hammered'], image: 'assets/img/appearances/M2-0-60DG.jpg' }, { title: 'Grey', range: 'Drift Wood', material: 'Stone', finishes: ['Matt', 'Polished', 'Bush Hammered'], image: 'assets/img/appearances/M2-0-60G.jpg' }, { title: 'Light Grey', range: 'Italian Stone', material: 'Porcelain', finishes: ['Matt', 'Polished', 'Bush Hammered'], image: 'assets/img/appearances/M2-0-60GH.jpg' }, { title: 'Light Grey', range: 'Italian Stone', material: 'Ceramic', finishes: ['Matt', 'Polished', 'Bush Hammered'], image: 'assets/img/appearances/M2-0-60GH.jpg' }];
	...
	var Another = React.createClass({
		...
		componentDidMount: function componentDidMount() {
			...
			$.getJSON('http://craft-api.dev/api/blog.json', function (data) {
				console.log(data.data);
				if (_this.isMounted()) {
					_this.setState({ APPEARANCES: data.data });
				}
			});
		},
		render: function render() {
			...
			var Appearances = appearances.map(function (appearance, index) {
				return React.createElement(
					...
					React.createElement(
						'div',
						{ className: 'm-b' },
						React.createElement('img', { src: appearance.image, alt: appearance.title }),
						appearance.title,
